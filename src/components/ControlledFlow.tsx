import React, { createContext, Dispatch, FC, ReactElement, SetStateAction } from 'react';
...
export const ControlledFlowContext = createContext<Partial<IControlledFlowContext>>({});
