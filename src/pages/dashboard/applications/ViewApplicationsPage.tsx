...
const ViewApplicationsPage = () => {
    ...
    const hasPermissionToCreate = !(applicationsData && currentAdmission && applicationsData.find(el => el?.admission === currentAdmission?.id)) && profile && moment().isBefore(moment(currentAdmission?.end_at)) && moment().diff(profile?.birth_date, "years") < 41;
